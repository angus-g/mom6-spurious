...
% NOTE linear waves shouldn't break and cause mixing, so be careful here
...
% TODO show z-tilde and rho coords as well (4-panel)
...
%
% TODO mention coordinate convention on z (z coordinate relative to surface)
% TODO explain discrepancy in $z_\text{bot}$ due to staggered grid (as in Petersen)
%
\begin{equation}
...
% TODO state which results come from which model, specify default MOM6 case is z-star
...
% TODO star symbol for z-star, more details in caption
...
% TODO why is there a minimum in the vertical contribution here? look at amplitude or frequency space for answers
