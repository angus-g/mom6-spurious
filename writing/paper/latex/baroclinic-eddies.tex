...
\begin{figure}
  ...
  % XXX old comment for advection scheme comparison
    %MOM6 using the default PLM tracer advection scheme is shown in magenta circles, with the alternate PPM:H3 scheme shown in magenta triangles at \SIlist{10;4}{\kilo\metre} resolution.}
\end{figure}
...
% TODO include vertical resolution stuff here

\begin{figure}
  %\includegraphics{../plots/eddies_drpe_split.pdf}
  \includegraphics{../plots/eddies_drpe_split_abs.pdf}
